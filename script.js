...
// API setup
const API_KEY = "AIzaSyD_EVVlE8UMuCj-a4KNh8pfCN9T0tZjB4g";
const API_URL = `https://generativelanguage.googleapis.com/v1/models/gemini-2.5-flash-latest:generateContent?key=${API_KEY}`;
