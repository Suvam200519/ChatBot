...
// API setup
const API_KEY = "AIzaSyBAikGlYda6defNrNqQezRCtdJFXolCiOw";
const API_URL = `https://generativeai.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=${API_KEY}`;
